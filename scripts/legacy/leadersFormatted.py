...
leaders = [
    ...
    # Seer
    {
        "name": "Seer",
        "abilities": (
            "*Prescient.* After you discard a Guild card with its **Prelude** action, you may take an action on the **Lead** **card**.\n"
            "*Narrow-minded.* You **cannot** discard a Guild card with it's Prelude action unless you're Leading or Surpassing."
        ),
        "resources": ["Psionic", "Psionic"],
        "setup": {
            "A": {"ships": 3, "building": "city"},
   ...
   # 
    ...
    # 
    {
        "name": "Envoy",
        "abilities": (
            "*Parleyed.* When defending in **battle**, at the start, you may discard a resource, if you do, the attacker can only collect Skirmish dice.\n"
            "*Unwary.* When defending in **battle**, if the attacker rolled any {icon:dice_key_black}, they gain 1 extra {icon:dice_key_black}."
        ),
        "resources": ["Fuel", "Psionic"],
        "setup": {
            "A": {"ships": 3, "building": "city"},
    ...
    
    {
        "name": "Tactician",
        "abilities": (
            "*Calculalative.* Before attacking in **battle**, roll an Assault or Raid die. This **battle** You may reroll any dice that match that die's face (empty matches empty).\n"
            "*Cautious.* You cannot move if it'd cause you to have ships in more than 4 different systems."
        ),
        "resources": ["Weapon", "Material"],
        "setup": {
            "A": {"ships": 3, "building": "city"},
...

    {
        "name": "Echo",
        "abilities": (
            "*Duplicative.* When attacking in **battle**, you may ignore the result of any die if the same face appears on another die you rolled.\n"
            "*Volatile.* When defending in **battle**, if the attacker rolled three identical faces, they gain 1 extra {icon:dice_hit_black}."
        ),
        "resources": ["Psionic", "Material"],
        "setup": {
            "A": {"ships": 3, "building": "city"},
...

    {
        "name": "z1",
        "abilities": (
            "*Reversed.* In battle, if you roll only raid dice, you may swap the amounts of keys and flame.\n"
            "*Cautious.* You cannot raid if the defender has any fresh ships in the battle system."
        ),
        "resources": ["Weapon", "Fuel"],
        "setup": {
            "A": {"ships": 3, "building": "city"},
...

    {
        "name": "z2",
        "abilities": (
            "*Piercing.* When attacking in battle, each intercept die you roll you roll also counts as hit hit.\n"
            "*.* ."
        ),
        "resources": ["Weapon", "Material"],
        "setup": {
...

    {
        "name": "z3",
        "abilities": (
            "*Leveraged.* After attacking in **battle**, if you rolled multiple skirmish dice and more than half have no {icon:dice_hit_black} on them, gain any any resource. *(After rerolls.)*\n"
            "*Indebted.* ."
        ),
        "resources": ["Material", "Fuel"],
        "setup": {
