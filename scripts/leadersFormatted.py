leaders = [
    ...
    },
    {
        "name": "Courier",
        "abilities": (
            "*Swift.* At the start of each chapter, place 3 agents on planets with no loyal pieces. When you **move** into one, return the agent and gain a resource matching that planet.\n"
